...
public class Startup
{
    ...
    private static void GetCommando(string[] inputParts)
    {
        ...
        ICommando commando = new Commando(int.Parse(inputParts[1]), inputParts[2], inputParts[3], decimal.Parse(inputParts[4]), corp, missions);
    ...
    private static void GetEngineer(string[] inputParts)
    {
        ...
        IEngineer engineer = new Engineer(int.Parse(inputParts[1]), inputParts[2], inputParts[3], decimal.Parse(inputParts[4]), corp, repairs);
    ...
    private static void GetLeutenantGeneral(string[] inputParts)
    {
        ...
        ILieutenantGeneral leutenantGeneral = new LeutenantGeneral(int.Parse(inputParts[1]), inputParts[2], inputParts[3], decimal.Parse(inputParts[4]), privates);
    ...
    {
        IPrivate @private = new Private(int.Parse(inputParts[1]), inputParts[2], inputParts[3], decimal.Parse(inputParts[4]));
